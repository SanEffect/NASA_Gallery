...
class MarsRoverPhotosResponse {
  ...
  factory MarsRoverPhotosResponse.fromJson(Map<String, dynamic> json) => _$MarsRoverPhotosResponseFromJson(json);
...
class MarsRoverPhotoResponse {
  ...
  MarsRoverPhotoResponse({
    ...
    required this.rover,
    required this.roverCamera,
  });
  factory MarsRoverPhotoResponse.fromJson(Map<String, dynamic> json) => _$MarsRoverPhotoResponseFromJson(json);
...
class MarsRover {
  ...
  factory MarsRover.fromJson(Map<String, dynamic> json) => _$MarsRoverFromJson(json);
...
class MarsRoverCamera {
  ...
  factory MarsRoverCamera.fromJson(Map<String, dynamic> json) => _$MarsRoverCameraFromJson(json);
